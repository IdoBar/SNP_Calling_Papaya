...
mamba create -n $CONDA_NAME sra-tools bcbio-gff libgd xorg-libxpm \
                ...
                entrez-direct parallel-fastq-dump mosdepth bamtools
# Clean extra space
...
# get WGS information from the SRA 
esearch -db sra -query XXXXX | efetch -format runinfo  | gawk -F "," '$13=="WGS"' > Cpapaya_XXXX_SRA_WGS_runinfo.csv

cat Cpapaya_PRJNA727683_SRA_WGS_runinfo.csv Cpapaya_XXXX_SRA_WGS_runinfo.csv > Cpapaya_All_SRA_WGS_runinfo.csv
