...
mamba create -n $CONDA_NAME sra-tools bcbio-gff libgd xorg-libxpm \
                ...
                libtiff qualimap multiqc bbmap fastp freebayes bedops vcf-kit \
...
The alleles of the filtered SNP variants of the 251 papaya accessions were concatenated and aligned into a multiple sequence alignment in `fasta` format with VCF-Kit in preparation for phylogenetic analysis.  
A maximum likelihood phylogenetic tree of the 251 papaya accessions was then constructed from the alignment file using [RAxML(NG)](https://github.com/amkozlov/raxml-ng/wiki)/[FastTree](https://morgannprice.github.io/fasttree/)/[IQ-TREE](https://iqtree.github.io/) [@kozlovRAxMLNGFastScalable2019; @pineiroVeryFastTree2020; @wongIQTREE3Phylogenomic2025]
...
CONDA_NAME="phylo"
mamba create -n $CONDA_NAME iqtree raxml raxml-ng veryfasttree danielecook::vcf-kit
