...
mamba create -n $CONDA_NAME sra-tools bcbio-gff libgd xorg-libxpm \
                ...
                libtiff qualimap multiqc bbmap fastp freebayes bedops snvphyl-tools \
...
### Data preparation
Create a folder for data processing (`$RUN_DIR`), then download and index the reference genome (Coffea Arabica ET-39, [GCF_036785885.1](https://www.ncbi.nlm.nih.gov/datasets/genome/GCF_036785885.1/), @salojarviGenomePopulationGenomics2024).
...
mkdir -p $WORK_DIR
datasets download genome accession GCF_036785885.1 --include gff3,rna,cds,protein,genome,seq-report
...
REFERENCE="/scratch/project/adna/Fawad/PAPHI003_hap2" # Holland_5 genome from Murdoch on Bunya HPC
cd $WORK_DIR
